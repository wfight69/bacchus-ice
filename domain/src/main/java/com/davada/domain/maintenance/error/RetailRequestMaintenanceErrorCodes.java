...
public enum RetailRequestMaintenanceErrorCodes implements ErrorCodes {
    ...
    REQUEST_MAINTENANCE_2001("냉장업체를 찾을 수 없습니다.[icesalerUuid: {0}]"),
    REQUEST_MAINTENANCE_2002("주류도매업체를 찾을 수 없습니다.[wholesalerUuid: {0}]"),
    REQUEST_MAINTENANCE_2003("유지관리자의 연락처 정보가 없습니다.[retailOrderTelephone: {0}]"),
    ;
