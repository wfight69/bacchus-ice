...
public class RetailOrder extends AuditableEntity implements Refinable {
    // 주문 UUID
    String orderUuid;
    // 주류도매업체 UUID
    ...
    String description;
    // 주문상품
    Set<RetailOrderItem> orderItems = new LinkedHashSet<>();
    //---------
    // 주문 채널
    ...
    public static RetailOrder getInstance() {
